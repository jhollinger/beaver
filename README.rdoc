...
== 3 DSLs are great and all, but what's really going on here?
  ...
  # You may just stop here if you like. The Request objects are now available through beaver.requests,
  # and that alone is quite useful.
  beaver.parse
